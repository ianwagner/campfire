      ...
      {results.length > 0 && (
        <div className="table-container mt-6">
          <div className="relative inline-block mb-2">
            ...
            {showColumnMenu && (
              <div className="absolute z-10 bg-white border rounded shadow p-2 right-0 dark:bg-[var(--dark-sidebar-bg)] dark:border-[var(--dark-sidebar-hover)] dark:text-[var(--dark-text)]">
                {columnMeta.map((c) => (
