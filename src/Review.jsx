        ...
        <div className="flex flex-col items-center">
          {agencyId && (
            <OptimizedImage
              ...
              cacheKey={agency.logoUrl || DEFAULT_LOGO_URL}
              onLoad={() => setLogoReady(true)}
              className="mb-4 sm:mb-6 max-h-16 w-auto"
            />
          )}
          <div className="mt-4 sm:mt-6 w-full px-4 sm:px-6 lg:px-8">
            <div
              ref={statusBarRef}
            ...
            >
              <div
                className={`w-full max-w-5xl sm:max-w-6xl overflow-hidden rounded-3xl border border-gray-200/80 shadow-lg backdrop-blur transition-all duration-300 dark:border-[var(--border-color-default)] ${
                  isStatusBarPinned
                    ? 'bg-white/80 dark:bg-[var(--dark-sidebar-bg)]/80 opacity-95 hover:opacity-100'
              ...
              >
                <div
                  ...
                  } ${isStatusBarPinned ? 'p-3 sm:p-4' : 'p-4 sm:p-6'}`}
                >
                  <div
                  ...
                  >
                    ...
                    >
                      <button
                        ...
                        className={`inline-flex items-center gap-2 rounded-full border text-sm font-semibold shadow-sm transition focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60 ${
                          isFinalized
                  ...
                  >
                    {statusCardItems.map(({ label, value }) => (
                      <div
                        key={label}
                        className={`rounded-2xl border border-gray-200/80 bg-white/80 shadow-sm transition-colors dark:border-[var(--border-color-default)] dark:bg-[var(--dark-sidebar-hover)] ${
