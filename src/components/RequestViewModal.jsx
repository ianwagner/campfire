...
import { toDateSafe } from '../utils/helpdeskUtils.js';
      ...
      <div className="space-y-2 p-2">
        ...
        {isHelpdesk && (
          <section className="mt-6 space-y-3">
            <h3 className="text-sm font-semibold text-gray-800 dark:text-[var(--dark-text)]">Helpdesk chat</h3>
            <div
              ref={messageListRef}
              className="max-h-80 space-y-3 overflow-y-auto rounded-xl border border-gray-200 bg-white px-4 py-3 shadow-sm dark:border-[var(--border-color-default)] dark:bg-[var(--dark-sidebar-bg)]"
            >
              {messages.length === 0 ? (
            ...
            <div className="rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 shadow-sm dark:border-[var(--border-color-default)] dark:bg-[var(--dark-sidebar-hover)]">
