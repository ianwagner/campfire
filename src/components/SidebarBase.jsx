    ...
    <>
      ...
      >
        <div className="space-y-2">
          <div className={`relative mx-auto mt-4 mb-4 ${logoUrl ? 'h-[90px]' : 'h-16'} flex-shrink-0 flex items-center justify-center`}>
            {!logoReady && (
        ...
        {open && (
          <div className="fixed inset-0 bg-white dark:bg-[var(--dark-sidebar-bg)] p-4 flex flex-col h-full justify-between z-50">
            ...
            <div className="space-y-2 mt-8">
              <div className={`relative mx-auto mt-4 mb-4 ${logoUrl ? 'h-[90px]' : 'h-16'} flex items-center justify-center`}>
                {!logoReady && (
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div className="loading-ring w-6 h-6" />
                  </div>
