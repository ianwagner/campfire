...
test('reviewVersion 2 renders all assets for selected version', async () => {
  const assetSnapshot = {
    docs: [
      {
        id: 'a1',
        data: () => ({
          firebaseUrl: 'v1-9x16.png',
          filename: 'BR1_GR1_RC1_9x16_V1.png',
          version: 1,
          status: 'ready',
          isResolved: false,
          adGroupId: 'group1',
      ...
      },
      {
        id: 'a2',
        data: () => ({
          firebaseUrl: 'v1-4x5.png',
          filename: 'BR1_GR1_RC1_4x5_V1.png',
          version: 1,
          status: 'ready',
          isResolved: false,
          adGroupId: 'group1',
      ...
      },
      {
        id: 'a3',
        data: () => ({
          firebaseUrl: 'v2-9x16.png',
          filename: 'BR1_GR1_RC1_9x16_V2.png',
          version: 2,
          parentAdId: 'a1',
          status: 'ready',
          isResolved: false,
      ...
      },
      {
        id: 'a4',
        data: () => ({
          firebaseUrl: 'v2-4x5.png',
          filename: 'BR1_GR1_RC1_4x5_V2.png',
          version: 2,
          parentAdId: 'a1',
          status: 'ready',
          isResolved: false,
  ...
  expect(srcs).toEqual(expect.arrayContaining(['v2-9x16.png', 'v2-4x5.png']));
});
